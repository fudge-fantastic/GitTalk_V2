    ...
    return (
        <div>
            ...
            <div className="mt-3">
                ...
                <div className="bg-zinc-100 dark:bg-zinc-900 shadow-sm shadow-zinc-400 dark:shadow-none rounded-md mt-3 h-auto overflow-auto pr-4 text-justify space-y-6 px-4 py-4">
                    {commits.length === 0 ? (
                                ...
                                <div className="flex items-center gap-4">
                                    ...
                                    <div className="flex flex-col">
                                        <div className="flex items-center gap-2 text-sm ">
                                            <Link to={commit.authorUrl ?? ''} target="_blank" className="font-medium text-sm" rel="noreferrer">{commit.authorName || "Unknown Author"}</Link>
